...
export function TriageDemoSection() {
  ...
  // Klaviaturadan Enter bosilganda
  ...
  // Mikrofon bosilganda (Ovozli kiritish simulyatsiyasi)
  const handleMicClick = () => {
    setIsListening(true);
    setComplaintInput("");
    // 2 soniyadan keyin avtomatik matn yoziladi va keyingi bosqichga o'tadi
    setTimeout(() => {
  ...
  // Savollarga javob berilganda (AI tahlili bosqichi)
  const handleAnswerClick = () => {
    setState("analyzing");
    // Sun'iy intellekt tahlil qilayotganini ko'rsatish uchun 2 soniya pauza
  ...
  return (
    <section className="py-24 px-6 bg-white">
      <div className="max-w-6xl mx-auto">
        ...
        {/* Kiosk Container */}
        <div className="bg-gray-100 rounded-[3rem] p-8 md:p-12 shadow-2xl border-8 border-gray-300 relative overflow-hidden">
          <div className="bg-white rounded-3xl p-12 md:p-16 min-h-[600px] flex flex-col justify-center transition-all duration-500">
            ...
            {state === "input" && (
              <div className="flex flex-col items-center justify-center flex-1 animate-in fade-in duration-500">
                ...
                <div className="w-full max-w-3xl mb-10">
                  <div className="relative">
                    <input
                      ...
                      className="w-full text-3xl md:text-4xl px-8 py-8 border-4 border-gray-300 rounded-3xl focus:outline-none focus:border-[#0056D2] bg-gray-50 pr-24"
                    />
                    <button 
                      onClick={handleMicClick}
                      aria-label="Ovozli yozish"
                      className={`absolute right-4 top-1/2 transform -translate-y-1/2 p-6 rounded-2xl transition-all duration-300 ${
                        isListening 
                ...
                <p className="text-2xl text-gray-600 mb-8">yoki tezkor tanlang:</p>
                ...
                <div className="mb-12">
                  ...
                  <div className="space-y-6">
                    <button
                      ...
                      className="w-full bg-white hover:bg-blue-50 text-gray-900 text-3xl px-10 py-8 rounded-3xl border-4 border-gray-300 hover:border-[#0056D2] transition-all duration-200 text-left"
                    >
                      Bugun boshlandi
                    </button>
                    <button
            ...
            {state === "result" && (
              <div className="flex flex-col items-center justify-center flex-1 animate-in zoom-in-95 duration-500">
                ...
                <div className="bg-gradient-to-br from-green-50 to-emerald-50 border-4 border-[#10b981] rounded-3xl p-12 w-full max-w-2xl shadow-xl relative overflow-hidden">
                  <div className="absolute top-0 right-0 w-32 h-32 bg-[#10b981] opacity-10 rounded-bl-full"></div>
                  <div className="space-y-8 relative z-10">
                    <div className="flex justify-between items-center border-b-2 border-green-200 pb-6">
                      ...
                      <span className="text-4xl font-bold text-gray-900">Terapevt</span>
                    </div>
                    
                    <div className="flex justify-between items-center border-b-2 border-green-200 pb-6">
                      <span className="text-3xl text-gray-700">Xona:</span>
                      <span className="text-4xl font-bold text-gray-900">12-xona</span>
                    </div>
                    
                    <div className="flex justify-between items-center">
                      <span className="text-3xl text-gray-700">Navbat:</span>
                      <span className="text-5xl font-bold text-[#0056D2]">#T-08</span>
                    </div>
                  </div>
                </div>
